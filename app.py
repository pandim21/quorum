...
def _sidebar() -> None:
    with st.sidebar:
        ...
        st.markdown('<div style="font-size:10.5px;color:#9AA8BC;margin-top:16px;line-height:1.5">Illustrative demo. Financial data are fixed snapshots as of 16 June 2026, 4:00 PM ET — not live market data, not investment advice.</div>', unsafe_allow_html=True)
